        ...
        <SafeAreaView style={globalStyles.androidSafeView}>
            <View style={{marginHorizontal: "auto", width: "80%", height: "100%"}}>
                <View style={{marginVertical: "auto"}}>
                    ...
                    <TextInput style={style.textInput} selectionColor={"rgba(255, 255, 255, 0.25)"}/>
                    ...
                    <Pressable onPress={() => {console.log("login pressed")}} style={[globalStyles.button, {marginHorizontal: "auto", width: "40%", height: "10%", marginTop: 20}]}>
